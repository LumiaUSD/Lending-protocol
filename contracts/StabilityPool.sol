...
contract StabilityPool is Ownable, ReentrancyGuard, Constants {
    ...
    function liquidate() external {
        ...
        uint256[] memory _collateralAmounts = new uint256[](_collateralCount);
        ...
        totalDeposit = newTotalDeposit;
        emit TotalDepositUpdated(newTotalDeposit);
        emit SPLiquidation(_underWaterDebt, _collaterals, _collateralAmounts);
    }

    // ! Todo fails: getWithdrawableDeposit
    /**
